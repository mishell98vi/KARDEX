...
public class KardexProductoImpl implements KardexProductoI{
    ...
    public ArrayList<Kardex> listadoKardexProducto(int codProducto) throws Exception {
        ...
        ResultSet res = null;
        Kardex nKardex=null;
        String comandoSQL = "Select codigoKardex, codigoProducto, fechaEmision, tipoTrasaccion, existecias, valortotal, cantidadEdicion From Kardex Where codigoProducto="+String.valueOf(codProducto);
