...
public class Form_EditarCategoria {
    ...
    public Form_EditarCategoria() {
        ...
        btnModificar = new Button("Eliminar");
        btnModificar.setFont(Font.font("News701 BT", 20));
    ...
    public void bModificarEventHandler(ActionEvent event) {
        ...
        try {
            categ.setNombre(nombre.getText());
            categ.setDescripcion(descripcion.getText());
                if(categDao.modificar(categ)> 0) {
                    System.out.println("Modificacion Correcta");
                }
                else{
                    System.out.println("Modificacion incorrecta");
                }
        } catch (Exception e) {
